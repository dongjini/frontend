...
console.log(`문자열 찾기 : ${msg1.match("ja")}`); // match는 찾는 문자열 돌려줌 -> ja
console.log(`문자열 찾기 : ${msg1.match("body")}`); // 없는건 -> null
console.log(`문자열 찾기(search - 시작위치) : ${msg1.search("ja")}`); // 시작 위치 돌려줌
