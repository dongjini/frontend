...
// "자전거", "자동차", "기차", "트럭", "오토바이"
array1.splice(2, 0, "킥보드"); // 삭제할 개수 : 0 이면 insert 개념으로 추가됨.
console.log("추가 후 확인 ", array1.toString());
planet.splice(6, 1, "명왕성"); // == planet[6] = "명왕성" / 삭제하면서 그자리에 대체
console.log("추가 후 확인 ", planet.toString());

// 배열 요소 삭제
// pop(뒤에서 삭제), shift(앞에서 삭제), splice(위치, 삭제할 개수)
console.log("\n--- 배열 요소 삭제");
...
others.splice(2, 2); // 추가의 개념(item 3번째 자리 까지 사용시), 삭제의 개념 다 사용(2자리만 사용)
